                ...
                <div className="max-w-[1600px] mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10 md:gap-12 lg:gap-8">
                        ...
                        <div className="text-center md:text-left">
                            <h4 className="text-white font-semibold mb-4 md:mb-6">Navigation</h4>
                        ...
                        {/* Legal */}
                        <div className="text-center md:text-left">
                            <h4 className="text-white font-semibold mb-4 md:mb-6">Legal</h4>
                            <ul className="space-y-2 md:space-y-3">
                        ...
                        {/* Follow Us */}
                        <div className="text-center md:text-left">
                            <h4 className="text-white font-semibold mb-4 md:mb-6">Follow Us</h4>
                            <ul className="space-y-2 md:space-y-3">
                            ...
                            <div className="mt-6 md:mt-8">
                                <p className="text-white/40 text-xs uppercase tracking-wider mb-2 md:mb-3">Contact</p>
                                <a href="mailto:hello@impulsifier.com" className="text-white/60 hover:text-[#ff6b00] transition-colors text-sm block">
